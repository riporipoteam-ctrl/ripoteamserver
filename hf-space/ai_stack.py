...
class AIStack:
    def __init__(self, *, home: Path, data_dir: Path, log_dir: Path) -> None:
        ...
        self.remote_pairing_url = os.environ.get("RIPO_PAIRING_COMMAND_URL", "https://raw.githubusercontent.com/riporipoteam-ctrl/ripoteamserver/main/runtime/telegram-pairing-command.json")
    ...
    def _persist_approved_ids(self, ids: list[str]) -> dict[str, Any]:
        if not ids:
