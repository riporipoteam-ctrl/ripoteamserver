...
The Space runs `app_server_v2:app` in a Debian-based Docker image. The image enables both amd64 and i386 so the same Wine prefix can run the 64-bit Aug 2021 Rec Room client and the official 32-bit Windows Steam bootstrap required by Steamworks.
